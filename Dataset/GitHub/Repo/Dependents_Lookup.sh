...
#src search -json "context:global file:clearml\.conf or /import clearml|from clearml.* import / count:all select:repo patternType:standard case:yes" >"$RAW_DIR/ClearML.json" # ClearML

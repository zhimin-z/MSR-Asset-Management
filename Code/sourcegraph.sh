...
src search -json "/pachctl create repo / case:yes count:all select:repo" > "$RAW_DIR/Pachyderm.json"
...
src search -json "/det experiment create / case:yes count:all select:repo" > "$RAW_DIR/Determined.json"
